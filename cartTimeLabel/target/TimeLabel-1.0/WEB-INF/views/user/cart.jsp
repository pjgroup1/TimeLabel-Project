					...
					<tbody>
						<c:forEach items="${cartInfo}" var="ci">
							<tr>
								...
								<td class="td_width_4 table_text_align_center">
									<button class="devare_btn" data-cartIndex="${ci.cartIndex}">삭제</button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
...
$(".quantity_modify_btn").on("click", function(){
	...
	var productCount = $(this).parent("td").find("input").val();
...
/* 장바구니 삭제 버튼 */
$(".devare_btn").on("click", function(e){
	e.preventDefault();
	const cartIndex = $(this).data("cartindex");
	$(".devare_cartIndex").val(cartIndex);
	$(".quantity_devare_form").submit();
});
