...
<%--    </aside>--%>
    <div id="container_box">
      ...
      <form role="form" method="post"  autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="inputArea">
          <label>1차 분류</label>
          <select class="category1" id="productCategoryIndex" name="productCategoryIndex">
...
<%--          </select>--%>
        ...
        <div class="inputArea">
          ...
          <textarea rows="5" cols="50" id="productInfo" name="productInfo"></textarea>
...
<!--           <script>
        ...
        <div class="inputArea">
          <label for="productMainImage">이미지</label>
...
<script>
  ...
  for(var i = 0; i < jsonData.length; i++) {
    // if(jsonData[i].level == "1")   // 레벨이 1인 데이터가 있다면
      ...
      cate1Obj.productCategoryIndex = jsonData[i].productCategoryIndex;
      cate1Obj.productCategoryName = jsonData[i].productCategoryName;
  ...
  for(var i = 0; i < cate1Arr.length; i++) {
    ...
    cate1Select.append("<option value='" + cate1Arr[i].productCategoryIndex + "'>"
            + cate1Arr[i].productCategoryName + "</option>");
  }
