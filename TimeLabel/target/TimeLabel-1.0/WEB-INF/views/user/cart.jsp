...
<div class="wrapper">
    ...
    <div class="content_area">
        ...
        <div class="content_totalCount_section">
            ...
            <form name="orderForm" id="orderForm" action="/order/payment" method="post">
                <!-- 체크박스 전체 여부 -->
                <div class="all_check_input_div">
                    <input type="checkbox" class="all_check_input input_size_20" checked="checked"><span
                        class="all_chcek_span">전체선택</span>
                </div>
                <table class="subject_table" style="border-collapse: separate; width: 1200px; height: 250px;">
                    ...
                    <c:forEach items="${cartInfo}" var="ci" varStatus="st">
                        <c:set var="totalPrice" value="${totalPrice + ci.productPrice * ci.productCount}"/>
                        <c:set var="totalDiscountPrice"
                               value="${totalDiscountPrice + ci.discountedPrice * ci.productCount}"/>
                        <tr id="itemRow${st.count}">
                            <td class="td_width_1 cart_info_td">
                                <input type="checkbox" class="individual_cart_checkbox input_size_20" name="check"
                                       checked="checked" value="${st.count}" data-cartNum="${ci.cartIndex}">
                                <input type="hidden" class="individual_cart_checkbox input_size_20"
                                ...
                                <input type="hidden" class="individual_productCount_input"
                                       name="productCount${st.count}" id="productCount" value="${ci.productCount}">
                                ...
                                <input type="hidden" class="individual_productIndex_input"
                                       name="productThumbImage${st.count}" value="${ci.productThumbImage}">
                                <input type="hidden" class="individual_productOptionIndex_input"
                                       name="productOptionIndex${st.count}" value="${ci.productOptionIndex}">
                                <input type="hidden" class="individual_productOptionIndex_input"
                                       name="productOptionValue${st.count}" value="${ci.productOptionValue}">
                            ...
                            <td class="td_width_2">
                                ...
                                <img src="${ci.productThumbImage}" style="width: 300px; height: 250px;" alt="상품 이미지">
                            </td>
                            <td class="td_width_3">${ci.productName}</td>
                            <td class="td_width_3">${ci.productOptionValue}</td>
                            <td class="td_width_4 price_td">
                                <del>정가 : <fmt:formatNumber value="${ci.productPrice}" pattern="#,### 원"/></del>
                                <br>
                                판매가 : <span class="red_color"><fmt:formatNumber value="${ci.discountedPrice}"
                                                                                pattern="#,### 원"/></span><br>
                            </td>
                            <td class="td_width_4 table_text_align_center">
                                <div class="table_text_align_center quantity_div">
                                    <input type="text" value="${ci.productCount}" class="quantity_input">
                                    <button type="button" id="${st.count}" class="quantity_btn plus_btn">+</button>
                                    <button type="button" id="${st.count}" class="quantity_btn minus_btn">-</button>
                                </div>
                            </td>
                                <%-- <td class="td_width_4 table_text_align_center">
                            ...
                            <td class="td_width_4 table_text_align_center">
                                    ...
                                    <div class="checkBox">
                                    <input type="hidden" name="cartIndex${st.count}" value="${ci.cartIndex}">
                                        <script>
                                    ...
                                    <div class="delete_btn">
                                        <button type="button" class="selectDelete_btn${ci.cartIndex}" data-cartNum="${ci.cartIndex}">삭제</button>
                                        <script>
                ...
                <br/>
                <br/>
                <input type="text" value="${totalDiscountPrice}" name="totalDiscountPrice"/>
                <br/>
                <textarea cols="30" rows="5" style="font-size: 15px; text-align: start;" type="text" class="individual_order_message_input"
                          name="orderMessage">shipping Message</textarea>
                <br/>
                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="finalTotalPrice_span">${totalDiscountPrice}</span> 원
                                    </td>
                                </tr>
                                </tbody>
                            </table>
