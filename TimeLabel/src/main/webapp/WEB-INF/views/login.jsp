...
<body bgcolor="#e1eff2">
	...
	<div id="wrap">
		<center>
			<b><font size="6" color="gray">저희 "타임라벨"에 오신 걸 환영합니다!</font></b>
		</center>
		<br> <br> <br>
		<form name="loginInfo" method="post" onsubmit="return checkValue()"
			...
			<center>
				<img
					src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxvbb28oyIcTfCHqnSegWvHOU9s7CY_cEozA&usqp=CAU"
					width="40%" , height="20%">
			</center>
			...
			<br> <input type="submit" value=" 로그인 "> <input
				type="button" value=" 회원가입 " onClick="goJoinForm()">
	</div>
	<br>
	<br>
	</form>
